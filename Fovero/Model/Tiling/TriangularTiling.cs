...
public sealed class TriangularTiling(ushort columns, ushort rows) : RegularTiling(columns, rows)
{
    ...
    public override Rectangle Bounds => new Rectangle(0, 0, Columns / 2f, Rows * CellHeight).InModelUnits();
    ...
    private record TriangleTile : ITile
    {
        ...
        public Rectangle Bounds => new Rectangle(_column / 2f, _row * CellHeight, 1, CellHeight).InModelUnits();
