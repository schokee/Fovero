...
public class PyramidTiling(ushort height) : ITiling
{
    ...
    public Rectangle Bounds => new Rectangle(0, 0, Height, CellHeight * Height).InModelUnits();
    ...
    private record TriangleTile : ITile
    {
        ...
        public Rectangle Bounds => new Rectangle((_format.Height - _row + _column) / 2f, _row * CellHeight, 1, CellHeight).InModelUnits();
